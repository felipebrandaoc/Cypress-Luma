...
Page Selectors are also provided on a folder named "selectors" inside this one. There you can find all the selectors divided by pages, and use them on the spec file by importing them.
